...
// Slug: boda-alejandro-mayra | Storage key: boda_alejandro_mayra_photo_selections
(function () {
    ...
    const EVENTO_SLUG   = 'boda-alejandro-mayra';
    const SB_KEY        = 'boda_alejandro_mayra_photo_selections';
